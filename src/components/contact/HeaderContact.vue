<template>
  <section class="position-relative">
      <div
        ...
        style="
          background-image: url('https://xingqiu-tuchuang-1256524210.cos.ap-shanghai.myqcloud.com/1754/246147.jpg');
        "
      >
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-6 text-center mx-auto">
              <h2 class="text-white mb-3">联系我们</h2>
              <p class="lead text-white mb-6">
                我们的管理员将阅读您的申请，管理员同意您的申请后将给您发送同意的邮件
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row mt-sm-0 mt-5">
          <div class="col-lg-3 col-md-4 border-end ms-lg-auto">
            <div class="p-3 text-center">
              ...
              <p class="text-info">
                <span class="__cf_email__">zzw17370709160@163.com
                </span>
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 border-end">
            <div class="p-3 text-center">
              ...
              <p class="text-info">+(86) 173 7070 9160</p>
            </div>
          </div>
