...
export default {
  ...
  mounted() {
    this.$router.beforeEach((to, from, next) => {
      ...
      if(to.path === '/financial' ||  to.path === '/apply' || to.path === '/blog/sigin' || to.path === '/activity/apply' || to.path === '/activity/donate' || to.path === '/activity/specific/sigin'|| to.path === '/activity/time' || to.path === '/media/list' || to.path === '/media/list/alone' || to.path === '/media/bilibili' || to.path === "/media/self" || to.path === "/legal" || to.path === "/legal/external" || to.path === "/biology/animals" || to.path === "/biology/action" || to.path === "/humanity/book" || to.path === "/humanity/list" || to.path === "/humanity/image" || to.path === "/blog/Siginblog/edtior" || to.path === "/financial/giving"){
